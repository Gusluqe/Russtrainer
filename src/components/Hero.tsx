        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-rose/10 border border-rose/20 rounded-full text-rose text-sm font-medium mb-6"
            >
            ...
            >
              ...
              <span className="text-gradient">con un plan hecho para vos</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-rose font-serif italic text-lg mb-4"
            >
            ...
            <div className="relative w-full max-w-sm lg:max-w-md">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-rose text-xs mt-0.5">Coach Personal Online</p>
                </div>
              </motion.div>
              ...
              >
                +100
                <span className="block text-xs font-sans font-normal opacity-90">clientes</span>
              </motion.div>
            </div>
          </motion.div>
        </div>
