    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-20 right-4 lg:bottom-6 lg:right-6 z-50 flex items-center gap-3"
        >
          <AnimatePresence>
            {showTooltip && (
              <motion.div
                ...
                className="hidden sm:block bg-white text-charcoal text-sm px-4 py-2 rounded-xl shadow-[0_4px_16px_rgba(0,0,0,0.12)] whitespace-nowrap font-medium border border-rose/20"
              >
          ...
          >
            ...
            <div className="relative flex items-center justify-center w-16 h-16 bg-[#25D366] rounded-full shadow-lg hover:shadow-[0_0_30px_rgba(37,211,102,0.5)] transition-shadow border-2 border-white/20">
              ...
              <span className="absolute -top-1 -right-1 flex h-4 w-4">
                ...
                <span className="relative inline-flex rounded-full h-4 w-4 bg-rose"></span>
              </span>
            </div>
          </motion.a>
        </motion.div>
